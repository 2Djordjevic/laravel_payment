<div class="page-sidebar-wrapper">
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            @php echo "active",(request()->path() != 'admin/blog')?:"";@endphp
            ...
            @php echo "active",(request()->path() != 'admin/slider')?:"";@endphp">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item  @php echo "active",(request()->path() != 'admin/background/images')?:"";@endphp">
            ...
            @php echo "active",(request()->path() != 'admin/withdraw/log')?:"";@endphp">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">Withdraw @if($req == 0)  @else<span class="badge badge-danger">{{$req}} @endif</span></span>
                    <span class="arrow"></span>
                </a>
                <ul class="sub-menu">
            ...
            @php echo "active",(request()->path() != 'admin/reject/advertise')?:"";@endphp">
                <a href="javascript:;" class="nav-link nav-toggle">
                    <i class="fas fa-spinner"></i>
                    <span class="title">Request Advertises  @if($ad_req == 0)  @else<span class="badge badge-danger">{{$ad_req}} @endif</span> </span>
                    <span class="arrow"></span>
                </a>
                <ul class="sub-menu">
                    <li class="nav-item  @if( request()->path() == 'admin/request/advertise' ) active open @endif">
                        <a href="{{route('req.add.index')}}" class="nav-link ">
                            ...
                            <span class="title">Reqests Advertise   @if($ad_req == 0)  @else<span class="badge badge-danger">{{$ad_req}} @endif</span></span>
                        </a>
                    </li>
